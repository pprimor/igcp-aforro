...
Simulate an IGCP Aforro Série D, E, or F cohort up to an as-of date.
...
- `--json` — emit machine-readable output. Stable across releases (changes are flagged in the [Changelog](/en/changelog/)).
