...
const COPY: Record<PlaygroundLocale, PortfolioCopy> = {
  ...
  'pt-PT': {
    heading: 'Simulador de portefolio',
    addRow: 'Adicionar grupo',
    removeRow: 'Remover',
    asOfDate: 'Data de referencia',
    series: 'Serie',
    subscriptionDate: 'Data de subscricao',
    units: 'Unidades',
    includeSchedule: 'Incluir calendario por grupo',
    totals: 'Totais',
    bySeries: 'Por serie',
    cohortDetails: 'Detalhe por grupo',
    rowLabel: 'Grupo',
    valueNet: 'Valor liquido',
    interestNet: 'Juro liquido',
